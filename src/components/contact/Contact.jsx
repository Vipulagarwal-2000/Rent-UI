  ...
  return (
    <div>
      ...
      <Card
        ...
        css2={"contact-class2"}
        h1={<h2 className="contact-card-one">Reach us Here</h2>}
        p={
          <div className="contact-card-one-div">
            <span id="contact-card-one-span1">
              <svg
                id="contact-svg"
            ...
            <span id="contact-card-one-span2">
              <svg
                id="contact-svg"
                xmlns="http://www.w3.org/2000/svg"
                width="16"
        ...
        h2={<h2 className="contact-card-one contact-card-one-margin">Contact form</h2>}
        p2={
          <div id="contactform">
